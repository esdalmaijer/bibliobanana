...
comparison_term = "brain"
# Alternative comparison term is "banana".
...
save_file = "neuroimaging_{}_{}-{}".format(comparison_term, start_date, \
    end_date)
...
if not os.path.isfile(save_file+".csv"):
    ...
    result = compute_yearly_citations(search_terms, start_date, end_date, \
        comparison_terms=comparison_term, database="pubmed", \
